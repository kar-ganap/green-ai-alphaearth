#!/usr/bin/env python3
"""
Temporal Validation with Hard Validation Sets - XGBoost Version
...
Uses XGBoost with best hyperparameters from Phase B
"""
...
def train_model(X_train, y_train):
    ...
    # Use best hyperparameters from Phase B
    model = XGBClassifier(
        n_estimators=300,
        max_depth=3,
        learning_rate=0.05,
...
def main():
    """Run all temporal validation phases with XGBoost."""
    print("="*80)
    print("TEMPORAL VALIDATION WITH HARD VALIDATION SETS - XGBOOST")
    print("="*80)
    ...
    # Save results
    output_file = PROCESSED_DIR / 'temporal_validation_hard_sets_xgboost_results.pkl'
    with open(output_file, 'wb') as f:
        pickle.dump(all_results, f)

    print(f"\n✓ Results saved to: {output_file}")
    print(f"✓ XGBoost temporal validation complete!")
